...
\begin{figure}
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.49\textwidth]{../Figures/digit1.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.49\textwidth]{../Figures/digit2.png}
    \end{subfigure}
    \caption{Plot of two digits}
\end{figure}
...
The training process involves a forward and backward pass. During the forward pass, the neuron values are calculated as described in section \ref{sec:neuron}. During the backward pass, errors are calculated and propagated backwards through the network and used to update the values of the weights. 
